...
{
    public static class MSXIntegrationInput
    {
        [FunctionName("MSXIntegrationInput")]
            ...
            ILogger log)
        {
            ...
            crmManager.InsertMSXDetailsIntoInputTable();
            //log.LogInformation("Insert MSX method is successfully executed");
        ...
        public static async Task Dispose(ILogger log)
        {
            await Task.Run(() =>
            {
                for (int i = 0; i < 100; i++)
                {
                    log.LogInformation(" Insert MSX Data method is successfully executed");
                }
            });
        }
    }
