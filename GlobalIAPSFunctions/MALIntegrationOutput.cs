...
{
    public static class MALIntegrationOutput
    {
        [FunctionName("MALIntegrationOutput")]
            ...
            ILogger log)
        {
            ...
            crmManager.RetrieveMALRecordsFromTable();
            //log.LogInformation("Update MAL Type method is successfully executed");
        ...
        public static async Task Dispose(ILogger log)
        {
            await Task.Run(() =>
            {
                for (int i = 0; i < 100; i++)
                {
                    log.LogInformation(" Update MAL Data method is successfully executed");
                }
            });
        }
    }
