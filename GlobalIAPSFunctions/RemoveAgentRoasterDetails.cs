...
namespace GlobalIAPSFunctions
{
    ...
    public static class RemoveAgentRoasterDetails
    {
        [FunctionName("RemoveAgentRoasterDetails")]
            ...
            ILogger log)
        {
            ...
            try
            {
                ...
                int deleteCount= crmManager.RemoveAgentRoasterDetails();

                log.LogInformation("Removed agent roster details successfully.");
