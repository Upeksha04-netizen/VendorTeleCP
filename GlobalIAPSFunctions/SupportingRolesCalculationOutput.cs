...
{
    public static class SupportingRolesCalculationOutput
    {
        [FunctionName("SupportingRolesCalculationOutput")]
            ...
            ILogger log)
        {
            ...
            crmManager.SupportingRolesCalculationOutput();
        ...
        public static async Task Dispose(ILogger log)
        {
            await Task.Run(() =>
            {
                for (int i = 0; i < 100; i++)
                {
                    log.LogInformation("Update to SupportingRolesCalculationOutput method is successfully executed");
                }
            });
        }
    }
