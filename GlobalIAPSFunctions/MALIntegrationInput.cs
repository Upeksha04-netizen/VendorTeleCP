...
{
    public static class MALIntegrationInput
    {
        [FunctionName("MALIntegrationInput")]
            ...
            ILogger log)
        {
            ...
            crmManager.InsertMalDetailsIntoTable();
            //log.LogInformation("Insert MAL Type method is successfully executed");
