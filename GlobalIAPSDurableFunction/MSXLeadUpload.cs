...
{
    public static class MSXLeadUpload
    {

        [FunctionName("MSXLeadUpload_HttpStart")]
    ...
    ILogger log)
        {
            string instanceId = await starter.StartNewAsync("MSXLeadUpload_Orchestration", null);
        ...
        [FunctionName("MSXLeadUpload_Orchestration")]
        public static async Task<List<string>> RunOrchestrator(
            [OrchestrationTrigger] IDurableOrchestrationContext context)
        {
            var outputs = new List<string>();

            outputs.Add(await context.CallActivityAsync<string>("MSXLeadUpload_Activity", "MSXLeadUpload"));

            return outputs;
        }

        [FunctionName("MSXLeadUpload_Activity")]
        public static string ExecuteBusinessLogic([ActivityTrigger] string name, ILogger log)
        {
            log.LogInformation($"MSXLeadUpload_Activity Started");
